                        ...
                        machine.onResultChange((poorMan) => {
                            ...
                            const t = setInterval(function () {
                                ...
                                $('.winner.masked:first').removeClass('masked')
                                    ...
                                    .append($("<span>").text(+' '+ countAll +' >> '+ poorMan[count]) );
                ...
                <div>
                    ...
                    <form id="edit-item-form" onSubmit={this.handleAdd}>
                        ...
                        <div className="item-list-container">
                            {<h2>รายการเข้าร่วม {this.state.items.length} รายการ</h2> }
                            ...
                            <label htmlFor="rand-without-replacement" className="text-left">
                                ...
                                Draw without replacement (เลือกตรงนี้ถ้าจับแบบไม่ซ้ำ)(ระบบจะ remove item ที่เคยจับแล้วออกไป)
                            </label>
                        </div>
